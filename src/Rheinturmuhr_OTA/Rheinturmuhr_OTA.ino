...
void setup() {
  ...
  Serial.begin(115200);
  Serial.println();
  Serial.print("Linear Clock V2.1 2019 A.Fischer");
  Serial.println();
  ...
  Serial.println(atoi(wTimezone));
  //timeZone=atoi(wTimezone);
...
ArduinoOTA.setHostname("mytestesp8266-uhr");
  ...
  // MD5(admin) = 21232f297a57a5a743894a0e4a801fc3
   ArduinoOTA.setPasswordHash("d61cfc04fb803d3a86a62f72870c6938");
